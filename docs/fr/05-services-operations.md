...
| <img src="../images/image15.png" />*Figure 5.1 — Couleur d'apparence du service*  |
|-----------------------------------------------------------------------------------------|

| <img src="../images/image16.png" />*Figure 5.1 — Formulaire de création d'un nouveau service*  |
|-------------------------------------------------------------------------------------------------------|
...
| <img src="../images/image19.png" />*Figure 5.4 — Page de détail montrant comment activer un service avec son opération*  |
|---------------------------------------------------------------------------------------------------------------------------------|

**Étape 6 :** En haut, vous pouvez également activer l'opération dans ce
service pour cette agence si vous le souhaitez.

| <img src="../images/image20.png" />*Figure 5.4 Agency Services tab showing master catalogue with activated and deactivated service for an agency (ex. Mankon)* |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
