...
| <img src="../images/image32.png" />*Figure 8.1 — Point d'entrée de l'Analytique dans la barre latérale et titre du tableau de bord selon le rôle*  |
|-----------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| <img src="../images/image33.png" />*Figure 8.2 — Sélecteur de Période avec toutes les options visibles*  |
|-----------------------------------------------------------------------------------------------------------------|
...
| <img src="../images/image35.png" />*Figure 8.4 — Panneau de performance réseau avec 6 cartes de performance* |
|-------------------------------------------------------------------------------------------------------------------------------------------------|
...
| <img src="../images/image36.png" />*Figure 8.5 — Classement des agences avec indicateurs de médailles, barres de progression et détails par agence* |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
|                                                                                                                                            |
|--------------------------------------------------------------------------------------------------------------------------------------------|
| <img src="../images/image37.png" />*Figure 8.6 — Tableau de bord Analytique Responsable (vue complète)* |
...
|                                                                                                                                                         |
|---------------------------------------------------------------------------------------------------------------------------------------------------------|
| <img src="../images/image39.png" />*Figure 8.9 — Répartition par service affichant la distribution proportionnelle entre les types de services*  |
